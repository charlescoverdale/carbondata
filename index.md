...
now covered by some form of carbon price, about 24% of global emissions.
The EU ETS alone prices ~40% of EU emissions and generates roughly EUR
40 billion a year in auction revenue. Voluntary carbon markets have
issued over 2 billion credits since 1996, and Article 6 of the Paris
Agreement is bringing a new wave of international carbon trading online.
...
- **RFF World Carbon Pricing Database** lives on GitHub as per-country
  CSVs in version-stamped folders
- **Berkeley VROD** aggregates five voluntary registries into a
  bimonthly XLSX release
- **CarbonPlan OffsetsDB** maintains daily parquet snapshots of
  voluntary credits in a public S3 bucket (the REST API was deprecated
  in 2026)
...
Compliance markets (EU ETS) trade around USD 70/tCO2. Nature-based
